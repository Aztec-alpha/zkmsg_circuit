...
import EasyPrivateVotingContractArtifactJson from '../../target/zkmsg-EasyPrivateVoting.json' assert { type: 'json' };
...
export class EasyPrivateVotingContract extends ContractBase {
  ...
  public static deploy(wallet: Wallet, admin: AztecAddressLike) {
    return new DeployMethod<EasyPrivateVotingContract>(Point.ZERO, wallet, EasyPrivateVotingContractArtifact, EasyPrivateVotingContract.at, Array.from(arguments).slice(1));
  }
  ...
  public static deployWithPublicKey(publicKey: PublicKey, wallet: Wallet, admin: AztecAddressLike) {
    return new DeployMethod<EasyPrivateVotingContract>(publicKey, wallet, EasyPrivateVotingContractArtifact, EasyPrivateVotingContract.at, Array.from(arguments).slice(2));
  }
